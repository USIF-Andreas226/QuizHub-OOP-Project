...
public class EditQuestionController {
    public Label errorEditingQuestion;
    ...
    public void onCreateQuestions(ActionEvent actionEvent)throws IOException {
        ...
        try {
            ...
            ((CreateQuestionsController) loader.getController()).initEditExamQuestions(State.exams.get(examTitles.indexOf(examChoice.getValue())));
            stage.getScene().setRoot(root);
        } catch (Exception e) {
            errorEditingQuestion.setText("Please Select An Exam!");
        }
    }
